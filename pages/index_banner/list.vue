<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="bannerfile,open_url,title,sort,category_id,status,description" :where="where" page-data="replace"
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/index_banner.js';
